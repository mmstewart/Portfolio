            ...
            <div className="row">
              <div className="col-l">
                <div className="desc">
                  ...
                  <div>
                    <p className="desc2">
                      The website you are currently looking at! Contains all the
                      skills I know, some of the projects I created, and
                ...
                <div className="desc">
                  ...
                  <div>
                    <p className="desc2">
                      ...
                      application to power off the servers once the temperature
                      of the laboratory passes the temperature limit.
                    </p>
                  </div>
                  <a
                    className="desc-link2"
            ...
            <div className="row">
              <div className="col-l">
                <div className="desc">
                  ...
                  <div>
                    <p className="desc2">
                      A server monitoring utility for capturing hardware status
                      and fault events. This tool allowed clients to view and
                      notifies of failures from physical disk, virtual disks,
                      fans, and power distribution units.
                    </p>
                    <p className="notice">
                      Cannot link the website or source code of the project
                      under company terms.
